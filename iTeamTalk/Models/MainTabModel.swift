...
final class MainTabModel: ObservableObject, TeamTalkEvent {
    ...
    let globalChatModel: GlobalChatViewModel
    let privateMessagesModel: PrivateMessagesViewModel
    let mediaStreamingModel: MediaStreamingViewModel
    let fileManagementModel: FileManagementViewModel
    let serverManagementModel: ServerManagementViewModel
    let eventHistoryModel: EventHistoryViewModel
    let connectionStatusModel: ConnectionStatusViewModel
    let onlineUsersModel: OnlineUsersViewModel
    let manageStatusModel: ManageStatusViewModel
    ...
    init(server: Server) {
        ...
        globalChatModel = GlobalChatViewModel()
        privateMessagesModel = PrivateMessagesViewModel()
        mediaStreamingModel = MediaStreamingViewModel()
        fileManagementModel = FileManagementViewModel()
        serverManagementModel = ServerManagementViewModel()
        eventHistoryModel = EventHistoryViewModel()
        connectionStatusModel = ConnectionStatusViewModel()
        onlineUsersModel = OnlineUsersViewModel()
        manageStatusModel = ManageStatusViewModel()
    ...
    func setup() {
        ...
        addToTTMessages(globalChatModel)
        addToTTMessages(privateMessagesModel)
        addToTTMessages(mediaStreamingModel)
        addToTTMessages(fileManagementModel)
        addToTTMessages(serverManagementModel)
        addToTTMessages(eventHistoryModel)
        addToTTMessages(connectionStatusModel)
        addToTTMessages(onlineUsersModel)
        addToTTMessages(manageStatusModel)
